...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.lableNew = [[UIImageView alloc] init];
        //self.lableNew.textColor = [UIColor redColor];
        //self.lableNew.layer.cornerRadius = 3;
        self.lableNew.image = [UIImage imageNamed:@"newest"];
        //self.lableNew.font = [UIFont systemFontOfSize:10];
...
//        self.lableNew.textAlignment = NSTextAlignmentCenter;
        ...
        self.lableHot = [[UIImageView alloc] init];
       ...
       // self.lableHot.font = [UIFont systemFontOfSize:10];
        ...
        self.lableContent2.font = [UIFont systemFontOfSize:10];
...
- (void)layoutSubviews
{
    ...
    self.lableNew.frame = CGRectMake(10, 17, 38, 17);
    self.lableHot.frame = CGRectMake(10, 37, 38, 17);
    self.lableContent1.frame = CGRectMake(CGRectGetMaxX(self.lableNew.frame)+5, self.lableNew.frame.origin.y, self.contentView.frame.size.width-60, 17);
    self.lableContent1.textColor = [UIColor darkGrayColor];
    self.lableContent2.frame = CGRectMake(CGRectGetMaxX(self.lableNew.frame)+5, self.lableHot.frame.origin.y, self.contentView.frame.size.width-60, 17);
    self.lableContent2.textColor = [UIColor darkGrayColor];
}
